...
import team_1 from "../assets/admin/img/team-1.jpg";
import logo from "../assets/admin/img/small-logos/logo-xd.svg";
...
export default function Dashboard() {
    ...
    useEffect( () => {
        ...
        var ctx = document.getElementById("chartBars").getContext("2d");
        ...
        var ctx_2 = document.getElementById("chartLine").getContext("2d");
        const line = new Chart(ctx_2, {
                type: "line",
                data: {
        ...
        var ctx_3 = document.getElementById("chartLine_tasks").getContext("2d");
        const task = new Chart(ctx_3, {
                type: "line",
                data: {
                    labels: ["Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"],
                    datasets: [{
                    ...
                    <div className="card z-index-2 ">
                        <div className="card-header p-0 position-relative mt-n4 mx-3 z-index-2 bg-transparent">
                            <div className="bg-gradient-primary shadow-primary border-radius-lg py-3 pe-1">
                                <div className="chart">
                                    <canvas id="chartBars" className="chart-canvas" height="170"/>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="card z-index-2  ">
                        <div className="card-header p-0 position-relative mt-n4 mx-3 z-index-2 bg-transparent">
                            <div className="bg-gradient-success shadow-success border-radius-lg py-3 pe-1">
                                <div className="chart">
                                    <canvas id="chartLine" className="chart-canvas" height="170"/>
                                </div>
                            </div>
                        </div>
                        <div className="card-body">
                    ...
                    <div className="card z-index-2 ">
                        <div className="card-header p-0 position-relative mt-n4 mx-3 z-index-2 bg-transparent">
                            <div className="bg-gradient-dark shadow-dark border-radius-lg py-3 pe-1">
                                <div className="chart">
                                    <canvas id="chartLine_tasks" className="chart-canvas" height="170"/>
                                </div>
                            </div>
                        </div>
                        <div className="card-body">
                    ...
                    <div className="table-responsive">
                        ...
                        <tbody>
                            ...
                            <td>
                                <div className="d-flex px-2 py-1">
                                <div>
                                    <img src={logo} className="avatar avatar-sm me-3" alt="atlassian"/>
                                </div>
                                <div className="d-flex flex-column justify-content-center">
                            ...
                            <td>
                                <div className="avatar-group mt-2">
                                <a href="#" className="avatar avatar-xs rounded-circle" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Romina Hadid">
                                    <img src={team_1} alt="team5"/>
                                </a>
                                <a href="#" className="avatar avatar-xs rounded-circle" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Jessica Doe">
                                    <img src={team_1} alt="team6"/>
                                </a>
                                </div>
                            </td>
                            <td className="align-middle text-center text-sm">
                            ...
                            <td>
                                <div className="d-flex px-2 py-1">
                                <div>
                                    <img src={logo} className="avatar avatar-sm me-3" alt="team7"/>
                                </div>
                                <div className="d-flex flex-column justify-content-center">
                            ...
                            <td>
                                <div className="avatar-group mt-2">
                                <a href="#" className="avatar avatar-xs rounded-circle" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Romina Hadid">
                                    <img src={team_1} alt="team8"/>
                                </a>
                                <a href="#" className="avatar avatar-xs rounded-circle" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Jessica Doe">
                                    <img src={team_1} alt="team9"/>
                                </a>
                                </div>
                            </td>
                            <td className="align-middle text-center text-sm">
                            ...
                            <td>
                                <div className="d-flex px-2 py-1">
                                <div>
                                    <img src={logo} className="avatar avatar-sm me-3" alt="spotify"/>
                                </div>
                                <div className="d-flex flex-column justify-content-center">
                            ...
                            <td>
                                <div className="avatar-group mt-2">
                                <a href="#" className="avatar avatar-xs rounded-circle" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Ryan Tompson">
                                    <img src={team_1} alt="user1"/>
                                </a>
                                <a href="#" className="avatar avatar-xs rounded-circle" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Romina Hadid">
                                    <img src={team_1} alt="user2"/>
                                </a>
                                <a href="#" className="avatar avatar-xs rounded-circle" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Alexander Smith">
                                    <img src={team_1} alt="user3"/>
                                </a>
                                <a href="#" className="avatar avatar-xs rounded-circle" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Jessica Doe">
                                    <img src={team_1} alt="user4"/>
                                </a>
                                </div>
                            </td>
                            <td className="align-middle text-center text-sm">
                            ...
                            <td>
                                <div className="d-flex px-2 py-1">
                                <div>
                                    <img src={logo} className="avatar avatar-sm me-3" alt="jira"/>
                                </div>
                                <div className="d-flex flex-column justify-content-center">
                            ...
                            <td>
                                <div className="d-flex px-2 py-1">
                                <div>
                                    <img src={logo} className="avatar avatar-sm me-3" alt="invision"/>
                                </div>
                                <div className="d-flex flex-column justify-content-center">
                            ...
                            <td>
                                <div className="avatar-group mt-2">
                                <a href="#" className="avatar avatar-xs rounded-circle" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Ryan Tompson">
                                    <img src={team_1} alt="user6"/>
                                </a>
                                <a href="#" className="avatar avatar-xs rounded-circle" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Jessica Doe">
                                    <img src={team_1} alt="user7"/>
                                </a>
                                </div>
                            </td>
                            <td className="align-middle text-center text-sm">
